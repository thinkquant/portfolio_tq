...
export function HeroBlock() {
  const iconLinks = [
    ...
    {
      href: 'mailto:daniel@thinkquant.co',
      icon: Mail,
      label: 'Email',
    },
  ];
  ...
  return (
    <section className="relative flex min-h-[calc(100svh-5rem)] w-full items-center justify-center overflow-hidden border-y border-border/80 bg-background">
      ...
      <div className="relative z-10 mx-auto w-full max-w-5xl px-6 py-12 text-center sm:px-8 lg:py-16">
        <motion.div
